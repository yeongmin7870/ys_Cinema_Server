...
public interface FoodPaymentRepository extends JpaRepository<FoodPayment,Integer> {
    ...
    @Query("SELECT f,o,fm FROM FoodPayment f, OrderList o, FoodMenu fm WHERE f.foodPaymentId = o.fp_No AND o.cId = :cId " +
    ...
    @Query("SELECT f,o,fm FROM FoodPayment f, NcOrderList o, FoodMenu fm WHERE f.foodPaymentId = o.fp_No AND o.nc_No = :nc_No " +
            "AND f.food_No = fm.foodMenuId")
