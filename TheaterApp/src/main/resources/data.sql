...
insert into movie (m_no,m_Actor2, m_Actor3,m_Actors,m_categories,m_content,m_director,m_end_date,m_hour,m_image_path,m_img,m_name,m_rating,m_star_score,m_start_date,movie_video_path,movie_video_name,m_tier) values (2,'엠마 스톤','존 레전드','라이언 고슬링','드라마','별들의 도시 라라랜드. 두 사람은 미완성인 서로의 무대를 만들어가기 시작한다.','데이미언 셔젤','20220601','127','./src/main/resources/serverImage/movieImage/', 'movie.jpeg', '라라랜드',0,0.0,'20201231','./src/main/resources/movieVideo/','Iwannagosea.mp4','12세 관람가');
...
insert into movie (m_no,m_Actor2, m_Actor3,m_Actors,m_categories,m_content,m_director,m_end_date,m_hour,m_image_path,m_img,m_name,m_rating,m_star_score,m_start_date,movie_video_path,movie_video_name,m_tier) values (6,'재지 비츠','로버트 드니로','호아킨 피닉스','스릴러','고담시의 광대 아서 플렉은 모두 미쳐가는 세상 속에서 그가 설 자리가 없음을 깨닫는데...','토드 필립스','20220601','123','./src/main/resources/serverImage/movieImage/', 'movie.jpeg', '조커',0,0.0,'20191002','./src/main/resources/movieVideo/','Iwannagosea.mp4','15세 관람가');
...
insert into movie (m_no,m_Actor2, m_Actor3,m_Actors,m_categories,m_content,m_director,m_end_date,m_hour,m_image_path,m_img,m_name,m_rating,m_star_score,m_start_date,movie_video_path,movie_video_name,m_tier) values (9,'에밀리 블런트','빌 팩스본','톰 크루즈','액션','근 미래 외계 종족의 침략으로 주인공은 전쟁에 참전하게 되어 죽고 타임 루프에 갇히는데...','더그 라이만','20220601','113','./src/main/resources/serverImage/movieImage/', 'movie.jpeg', '엣지 오브 투모로우',0,0.0,'20140604','./src/main/resources/movieVideo/','Iwannagosea.mp4','12세 관람가');
